...
Status: **v0.2 — decisions D1–D9 adopted by Miko 2026-09-26 (all nine recommendations); Phase 0 built the same day** (0.1 server fix awaiting deploy; 0.2 harness + 12 scenarios; 0.3 not started). Decision-log entries: `documentation/GUIDELINES.md` 2026-09-26. Source of every item:
