...
- **Status**: Fixed for future builds (unverified until the next archive — check the dSYMs tab shows no "Missing (required)" for that version). Old crashes: pending the ASC download.
