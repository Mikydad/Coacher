...
class _AppLifecycleTaskRefreshState
  ...
  void initState() {
    ...
    SiriVoiceEntry.init();
    // Siri "Log activity" (Time Tracker V1.1): same pending-flag pattern.
    SiriLogActivity.init();
  ...
  Future<void> _drainLaunchNotificationResponse() async {
    ...
    unawaited(SiriLogActivity.consumePendingLog());
