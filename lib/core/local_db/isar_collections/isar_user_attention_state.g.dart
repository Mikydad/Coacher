...
const IsarUserAttentionStateSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'stateId': PropertySchema(id: 4, name: r'stateId', type: IsarType.string),
...
extension IsarUserAttentionStateByIndex
  ...
  List<Id> putAllByStateIdSync(
    List<IsarUserAttentionState> objects, {
    bool saveLinks = true,
  }) {
...
extension IsarUserAttentionStateQueryWhere
    on
        QueryBuilder<
          IsarUserAttentionState,
          IsarUserAttentionState,
          QWhereClause
        > {
  QueryBuilder<
  ...
  QueryBuilder<
    ...
    QAfterWhereClause
  >
  activeOverrideEqualTo(String activeOverride) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<
    ...
    QAfterWhereClause
  >
  activeOverrideNotEqualTo(String activeOverride) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
...
extension IsarUserAttentionStateQueryFilter
    on
        QueryBuilder<
          IsarUserAttentionState,
          IsarUserAttentionState,
  ...
  >
  activeOverrideEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  activeOverrideStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  activeOverrideEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  activeOverrideIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'activeOverride', value: ''),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  activeOverrideIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'activeOverride', value: ''),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  manuallyMutedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'manuallyMuted', value: value),
      );
    });
  }
...
extension IsarUserAttentionStateQueryObject
    on
        QueryBuilder<
          IsarUserAttentionState,
          IsarUserAttentionState,
...
extension IsarUserAttentionStateQueryLinks
    on
        QueryBuilder<
          IsarUserAttentionState,
          IsarUserAttentionState,
...
extension IsarUserAttentionStateQuerySortThenBy
    on
        QueryBuilder<
          IsarUserAttentionState,
          IsarUserAttentionState,
...
extension IsarUserAttentionStateQueryProperty
    on
        QueryBuilder<
          IsarUserAttentionState,
          IsarUserAttentionState,
