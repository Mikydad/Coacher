...
class AppPalette {
  ...
  static const AppPalette light = AppPalette(
    ...
    gray3A: Color(0xFFD6D6D6),
    gray33: Color(0xFFDDDDDD),
    gray2A: Color(0xFFE5E5E5),
    grayWarm: Color(0xFF8A8686),
    dark0B0D10: Color(0xFFF9F9F9),
    dark0D1117: Color(0xFFFFFFFF),
    dark0F0F1A: Color(0xFFF9F9F9),
    ...
    dark1A1D22: Color(0xFFF3F3F3),
    dark1A2535: Color(0xFFE7F0FA),
    dark1E1E1E: Color(0xFFE5E5E5),
    dark1E1E2E: Color(0xFFF3F3F3),
    dark1E2A2A: Color(0xFFE6F0F0),
    dark1F2026: Color(0xFFEEEEEE),
    dark222528: Color(0xFFEEEEEE),
    dark2A2D32: Color(0xFFE2E2E2),
    dark2A2D33: Color(0xFFE8E8E8),
    dark2B2D31: Color(0xFFE8E8E8),
    dark2C2C2C: Color(0xFFE2E2E2),
