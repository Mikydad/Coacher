...
const Map<PatternCode, PatternTaxonomySpec>
kPatternTaxonomyByCode = <PatternCode, PatternTaxonomySpec>{
  ...
  PatternCode.lateBehavior: PatternTaxonomySpec(
    ...
    description:
        'Share of completions after scheduled instants exceeds threshold.',
    requiredLayer1MetricPaths: <String>[
  ...
  PatternCode.tooHard: PatternTaxonomySpec(
    ...
    description:
        'Very low completion signal with elevated snooze/defer pressure.',
    requiredLayer1MetricPaths: <String>[
      'layer1.completionSignal7d',
  ...
  PatternCode.goalProgressDrift: PatternTaxonomySpec(
    ...
    description:
        'Goal progress materially lags expected trajectory (gap metric).',
    requiredLayer1MetricPaths: <String>[
