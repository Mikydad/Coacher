...
const Map<(FocusReason, CoachingFraming), _FallbackTemplate> _kTemplates = {
  ...
  (FocusReason.imminentStreakRisk, CoachingFraming.protection): _FallbackTemplate(
    summary:
  ...
  (FocusReason.highestMomentumLeverage, CoachingFraming.momentum): _FallbackTemplate(
    summary:
  ...
  (FocusReason.highestMomentumLeverage, CoachingFraming.consistency): _FallbackTemplate(
    summary:
  ...
  (FocusReason.bestRecoveryOpportunity, CoachingFraming.recovery): _FallbackTemplate(
    summary:
        'This is a good moment to get back on track. Small steps now rebuild your routine naturally.',
    recommendation: 'Start with one simple action to reconnect with your habit.',
    tone: CoachingTone.supportive,
  ),
  (FocusReason.bestRecoveryOpportunity, CoachingFraming.consistency): _FallbackTemplate(
    summary:
        'Returning to your routine is the most effective move right now.',
    recommendation: 'Pick up where you left off with one small action today.',
    tone: CoachingTone.informative,
  ),

  // ── Overdue item critical ────────────────────────────────────────────────────
  (FocusReason.overdueItemCritical, CoachingFraming.protection): _FallbackTemplate(
    summary:
  ...
  (FocusReason.overdueItemCritical, CoachingFraming.recovery): _FallbackTemplate(
    summary:
  ...
  (FocusReason.scheduledWindowActive, CoachingFraming.momentum): _FallbackTemplate(
    summary:
  ...
  (FocusReason.scheduledWindowActive, CoachingFraming.consistency): _FallbackTemplate(
    summary:
  ...
  (FocusReason.globalOverloadSignal, CoachingFraming.stabilization): _FallbackTemplate(
    summary:
  ...
  (FocusReason.globalOverloadSignal, CoachingFraming.protection): _FallbackTemplate(
    summary:
        'Overload is building up. Protecting your core habits now prevents deeper disruption.',
    recommendation: 'Protect your most important habit — skip non-essentials today.',
    tone: CoachingTone.assertive,
  ),

  // ── Consistency breakdown alert ──────────────────────────────────────────────
  (FocusReason.consistencyBreakdownAlert, CoachingFraming.protection): _FallbackTemplate(
    summary:
        'Your consistency pattern is weakening. Re-engaging today stops the slide early.',
    recommendation: 'Complete today\'s planned action to halt the consistency drop.',
    tone: CoachingTone.assertive,
  ),
  (FocusReason.consistencyBreakdownAlert, CoachingFraming.stabilization): _FallbackTemplate(
    summary:
  ...
  // ── Goal drift detected ──────────────────────────────────────────────────────
  (FocusReason.goalDriftDetected, CoachingFraming.stabilization): _FallbackTemplate(
    summary:
  ...
  (FocusReason.goalDriftDetected, CoachingFraming.protection): _FallbackTemplate(
    summary:
        'Your goal is drifting off track. Acting today prevents it from becoming a longer gap.',
    recommendation: 'Do the smallest useful action for your goal before today ends.',
    tone: CoachingTone.assertive,
  ),

  // ── Reinforcing active streak ─────────────────────────────────────────────────
  (FocusReason.reinforcingActiveStreak, CoachingFraming.momentum): _FallbackTemplate(
    summary:
  ...
  (FocusReason.reinforcingActiveStreak, CoachingFraming.consistency): _FallbackTemplate(
    summary:
  ...
  (FocusReason.timingOpportunity, CoachingFraming.consistency): _FallbackTemplate(
    summary:
...
const Map<FocusReason, _FallbackTemplate> _kReasonFallbacks = {
  FocusReason.imminentStreakRisk: _FallbackTemplate(
    summary: 'Your streak needs attention today. A short session protects your progress.',
    recommendation: 'Complete a brief action before the day ends.',
    tone: CoachingTone.assertive,
  ),
  FocusReason.highestMomentumLeverage: _FallbackTemplate(
    summary: 'Strong momentum right now. This is a great time to act on your priorities.',
  ...
  FocusReason.timingOpportunity: _FallbackTemplate(
    ...
    recommendation: 'Act during this window — it aligns with your best performance times.',
    tone: CoachingTone.informative,
  ),
};
...
class DeterministicCoachingRenderer {
  ...
  AiSummaryResponse render({
    ...
    final template = _kTemplates[(focusReason, payload.framing)] ??
    ...
    return AiSummaryResponse(
      ...
      isFallback: true,
      metadata: {
        if (failureReason != null) 'fallbackReason': failureReason,
      },
    );
  }
}
